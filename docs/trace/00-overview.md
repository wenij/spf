...
2. `08-append-a.md`：若你對 IA-32 組語與 SP-Forth assembler 還不熟，先補這章。
3. `01-kernel.md`：理解 TOS-in-EAX、定義字與核心原語。
4. `02-compiler.md`：理解 parser / search-order / interpreter / compiler。
5. `03-cross-compiler.md`：理解 host / target / meta-compilation。
