...
如果你想深入了解 `ac-lib3/` 的功能分類、代表檔案與實際用途，請直接看新增的專章 [16-ac-lib3.md](16-ac-lib3.md)。那一章會更完整地說明：
...
15. `16-ac-lib3.md`：若你想找整理過的延伸函式庫與工具箱，先看這章；它會告訴你 `ac-lib3/` 各 library family 適合解哪些問題。
16. `17-devel.md`：若你想追作者工作區、歷史原型、framework/app 範例與 build helper 來源，再看這章。
